...
from .views import cadastro_view, home_view, login_view, logout_view, gerenciar_pedidos_view, produtos, fazer_pedido, usuario, deletar_conta, login_redirect_view, dashboard_cantineiro, painel_usuario
